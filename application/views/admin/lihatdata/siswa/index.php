                                            ...
                                            <tbody>
                                                ...
                                                <?php foreach($siswa as $sw) : ?>
                                                    <tr class="gradeX">
                                                        ...
                                                        <td><?= $sw->alamat; ?></td>
                                                        <td class="actions">
                                                            <a href="<?=site_url('admin/lihatdata/editsiswa/'.$sw->id);?>"><span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Edit</a>
                                                            <a class="pull-right" href="<?=site_url('admin/lihatdata/destroysiswa/'.$sw->id);?>"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete</a>
                                                        </td>
