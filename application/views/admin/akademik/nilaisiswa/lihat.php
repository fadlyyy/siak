                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-heading"><h3 class="panel-title">Nilai Siswa</h3></div>
                                        ...
                                        <tbody>
                                            ...
                                            <?php foreach($nilai as $sw) : ?>
                                                <tr class="gradeX">
                                                    ...
                                                    <td><?= $sw->afektif; ?></td>
                                                    <td><?= $sw->komulatif; ?></td>
                                                    <td><?= $sw->psikomotorik; ?></td>
                                                    <td><?= $sw->rata; ?></td>
                                                    <td class="actions">
                                                        <a href="#" class="hidden on-editing save-row"><i class="fa fa-save"></i></a>
                                                        <a href="#" class="hidden on-editing cancel-row"><i class="fa fa-times"></i></a>
                                                        <a href="<?= site_url('admin/lihatdata/editguru/'.$sw->id);?>" class="on-default edit-row"><i class="fa fa-pencil" siswa="<?= $sw->id;?>"></i></a>
