...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo base_url('assets/lte/bower_components/jquery-ui/jquery-ui.min.js');?>"></script>
...
<!-- Sparkline -->
<script src="<?php echo base_url('assets/lte/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js');?>"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url('assets/lte/bower_components/jquery-knob/dist/jquery.knob.min.js');?>"></script>
<!-- daterangepicker -->
<script src="<?php echo base_url('assets/lte/bower_components/moment/min/moment.min.js');?>"></script>
<script src="<?php echo base_url('assets/lte/bower_components/bootstrap-daterangepicker/daterangepicker.js');?>"></script>
<!-- datepicker -->
